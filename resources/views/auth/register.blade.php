            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="username" class="col-md-4 col-form-label text-md-right">{{ __('รหัสนัศึกษา') }}</label>
                            ...
                            <div class="col-md-6">
                                ...
                                @if ($errors->has('username'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>รหัสนี้ถูกใข้งานไปแล้ว กรุณาติดต่อเจ้าหน้าที่</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                @if ($errors->has('email'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>อีเมลนี้ถูกใข้งานไปแล้ว กรุณาติดต่อเจ้าหน้าที่</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
